...
test.describe('ProcessExportResource API Tests', () => {
  test('@smoke POST /api/process/export - getAllProcessForExport - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/process/export - getExportReportForMappedProcess - Happy Path', async ({ authenticatedApi }) => {
