...
test.describe('ControlComplianceMapResource API Tests', () => {
  test('@smoke POST /api/control-compliance-map - createControlComplianceMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control-compliance-map/{id} - getControlComplianceMap - Happy Path', async ({ authenticatedApi }) => {
