...
test.describe('LocationEntityExportResource API Tests', () => {
  test('@smoke POST /api/location-entity/export - getAllEntitesForExport - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/location-entity/export - getAllEntitesForMappedExport - Happy Path', async ({ authenticatedApi }) => {
