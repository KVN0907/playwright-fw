...
test.describe('RoleSecurityGroupResource API Tests', () => {
  test('@smoke POST /api/role-security-groups - createRoleSecurityGroup - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/role-security-groups - notAssignableSecurityGroup', async ({
    authenticatedApi,
  }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/role-security-groups');
    } catch (error) {
  ...
  test('@negative POST /api/role-security-groups - idexists', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/role-security-groups', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative POST /api/role-security-groups - roleSecurityGroupCombinationExist', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke PUT /api/role-security-groups - updateRoleSecurityGroup - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/role-security-groups - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/role-security-groups', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/role-security-groups - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/role-security-groups');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/role-security-groups - notEditableRoleSecurityGroup', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/role-security-groups - roleSecurityGroupCombinationExist', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: roleSecurityGroupCombinationExist');
  ...
  test('@negative PUT /api/role-security-groups - notAssignableSecurityGroup', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: notAssignableSecurityGroup');
  ...
  test('@smoke GET /api/role-security-groups - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/role-security-groups/getById - getRoleSecurityGroup - Happy Path', async ({
    authenticatedApi,
  }) => {
