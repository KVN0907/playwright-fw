...
test.describe('ProcessLocationMapResource API Tests', () => {
  test('@smoke POST /api/process-location-maps - createProcessLocationMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/process-location-maps - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/process-location-maps/{processId} - getProcessLocationMap - Happy Path', async ({ authenticatedApi }) => {
