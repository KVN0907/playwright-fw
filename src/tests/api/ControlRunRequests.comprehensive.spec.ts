...
test.describe('ControlRunRequestsResource API Tests', () => {
  test('@smoke POST /api/control-run-requests - createControlRunRequests - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/control-run-requests/{id} - updateControlRunRequests - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/control-run-requests/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/control-run-requests/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/control-run-requests/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/control-run-requests/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PATCH /api/control-run-requests - partialUpdateControlRunRequests - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PATCH /api/control-run-requests - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PATCH request with invalid data
    try {
      const response = await authenticatedApi.patch('/api/control-run-requests');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/control-run-requests - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control-run-requests/{id} - getControlRunRequests - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/control-run-requests/{id} - deleteControlRunRequests - Happy Path', async ({ authenticatedApi }) => {
