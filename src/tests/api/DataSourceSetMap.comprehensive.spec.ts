...
test.describe('DataSourceSetMapResource API Tests', () => {
  test('@smoke POST /api/data-source-set-maps - createDataSourceSetMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/data-source-set-maps/{id} - updateDataSourceSetMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/data-source-set-maps/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/data-source-set-maps/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/data-source-set-maps/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/data-source-set-maps/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PATCH /api/data-source-set-maps - partialUpdateDataSourceSetMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PATCH /api/data-source-set-maps - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PATCH request with invalid data
    try {
      const response = await authenticatedApi.patch('/api/data-source-set-maps');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/data-source-set-maps - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/data-source-set-maps/{id} - getDataSourceSetMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/data-source-set-maps/{id} - deleteDataSourceSetMap - Happy Path', async ({ authenticatedApi }) => {
