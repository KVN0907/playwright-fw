...
test.describe('ControlResource API Tests', () => {
  ...
  test('@negative POST /api/control - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      const response = await authenticatedApi.post('/api/control', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/control/{id} - updateControl - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/control/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    try {
      const response = await authenticatedApi.put('/api/control/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/control/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/control/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/control/filter-options - getAllFilterOptions - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/application-details-from-list-page/{id} - getApplicationDetailsFromListPage - Happy Path', async ({ authenticatedApi }) => {
    ...
    // When making authenticated GET request
    const response = await authenticatedApi.get('/api/control/application-details-from-list-page/${id}');
  ...
  test('@smoke GET /api/controldownloadByDocId/{controlDocId} - downloadControlDocByDocId - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/nature-type - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/engine-type - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/frequency-type - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/details/{id} - getControl - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/controltoggle-status/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control/bulk-upload/edit-template - downloadBulkEditTemplate - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/control - bulkUploadControls - Happy Path', async ({ authenticatedApi }) => {
    Log.info('Testing POST /api/control');
  ...
  test('@smoke GET /api/control/{id} - getControlDetails - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/control/list-items - unknown - Happy Path', async ({ authenticatedApi }) => {
