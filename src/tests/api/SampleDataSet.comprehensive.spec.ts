...
test.describe('SampleDataSetResource API Tests', () => {
  test('@smoke POST /api/sample-data-sets - createSampleDataSet - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/sample-data-sets/{id} - updateSampleDataSet - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/sample-data-sets/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/sample-data-sets/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/sample-data-sets/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/sample-data-sets/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PATCH /api/sample-data-sets - partialUpdateSampleDataSet - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PATCH /api/sample-data-sets - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PATCH request with invalid data
    try {
      const response = await authenticatedApi.patch('/api/sample-data-sets');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/sample-data-sets/{id} - getSampleDataSet - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/sample-data-sets/{id} - deleteSampleDataSet - Happy Path', async ({ authenticatedApi }) => {
