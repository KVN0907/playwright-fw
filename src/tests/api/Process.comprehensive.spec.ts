...
test.describe('ProcessResource API Tests', () => {
  ...
  test('@negative POST /api/process - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/process', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/process/{id} - updateProcess - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/process/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/process/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/process/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/process/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/process/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/process/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/processdownloadByDocId/{processDocId} - downloadProcessDocByDocId - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke DELETE /api/process/deleteByProcessDocId/{processDocId} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.delete(
      '/api/process/deleteByProcessDocId/${processDocId}'
    );
  ...
  test('@smoke GET /api/process/{id} - getProcessDetails - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/process/approved/{id} - getApprovedProcessDetails - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/process/fetchAllSubprocesses/{id} - getProcessDetailsWithAllSubprocesses - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/processtoggle-status/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/process/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/process/bulk-upload/edit-template - downloadBulkEditTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/process - bulkUploadProcesses - Happy Path', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing POST /api/process');
  ...
  test('@negative POST /api/process - invalidfile', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/process');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/process/list-items - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
