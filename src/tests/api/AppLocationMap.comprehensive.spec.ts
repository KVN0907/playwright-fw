...
test.describe('AppLocationMapResource API Tests', () => {
  test('@smoke POST /api/app-location-maps - createAppLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/app-location-maps - applicationIdNotFound', async ({
    authenticatedApi,
  }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/app-location-maps');
    } catch (error) {
  ...
  test('@negative POST /api/app-location-maps - invalidCountryIds', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/app-location-maps/save-as-draft - saveAsDraftAppLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.post(
      '/api/app-location-maps/save-as-draft',
      requestData
    );
  ...
  test('@negative POST /api/app-location-maps/save-as-draft - applicationIdNotFound', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: applicationIdNotFound');
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/app-location-maps/save-as-draft');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/app-location-maps/{applicationId} - getAppLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
