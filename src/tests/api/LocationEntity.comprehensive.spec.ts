...
test.describe('LocationEntityResource API Tests', () => {
  test('@smoke POST /api/location-entity - createLocationEntity - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/location-entity - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/location-entity', requestData);
    } catch (error) {
  ...
  test('@negative POST /api/location-entity - countrynotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/location-entity');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/location-entity/{id} - updateLocationEntity - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/location-entity/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/location-entity/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/location-entity/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/location-entity/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/location-entity/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/location-entity/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/location-entity/{id} - countrynotfound', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: countrynotfound');
  ...
  test('@smoke GET /api/location-entity/all - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/location-entity/list - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/location-entity/{id} - getLocationEntity - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/location-entitytoggle-status/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/location-entity/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/location-entity - bulkUploadEntites - Happy Path', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing POST /api/location-entity');
  ...
  test('@smoke GET /api/location-entity/bulk-upload/edit-template - downloadBulkEditTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke DELETE /api/location-entity/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative DELETE /api/location-entity/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.delete('/api/location-entity/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/location-entity/list-items - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
