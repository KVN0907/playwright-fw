...
test.describe('ControlRiskMapResource API Tests', () => {
  test('@smoke POST /api/control-risk-map/risk-list - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/control-risk-map - createControlRiskMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control-risk-map/{id} - getControlRiskMap - Happy Path', async ({ authenticatedApi }) => {
