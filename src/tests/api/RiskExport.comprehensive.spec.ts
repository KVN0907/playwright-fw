...
test.describe('RiskExportResource API Tests', () => {
  test('@smoke POST /api/risk/export - getAllRiskForExport - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/risk/export - getExportReportForMappedRisk - Happy Path', async ({ authenticatedApi }) => {
