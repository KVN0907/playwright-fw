...
test.describe('DelegateResource API Tests', () => {
  ...
  test('@negative POST /api/delegates - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/delegates', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/delegates/{id} - updateDelegate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/delegates/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/delegates/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/delegates/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/delegates/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/delegates/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/delegates/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/delegates/{id} - getDelegate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/delegatestoggle-status/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
