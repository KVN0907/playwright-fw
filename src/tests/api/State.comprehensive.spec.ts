...
test.describe('StateResource API Tests', () => {
  test('@smoke GET /api/states/country/{countryId} - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/states/country/{countryId}/active - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/states/exists - checkStateExists - Happy Path', async ({ authenticatedApi }) => {
