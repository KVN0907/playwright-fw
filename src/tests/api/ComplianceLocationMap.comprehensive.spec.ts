...
test.describe('ComplianceLocationMapResource API Tests', () => {
  test('@smoke POST /api/compliance-location-maps - createComplianceLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/compliance-location-maps/save-as-draft - saveAsDraftComplianceLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.post(
      '/api/compliance-location-maps/save-as-draft',
      requestData
    );
  ...
  test('@smoke GET /api/compliance-location-maps/{complianceId} - getComplianceLocationMap - Happy Path', async ({
    authenticatedApi,
  }) => {
