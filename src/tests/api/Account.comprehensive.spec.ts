...
test.describe('AccountResource API Tests', () => {
  ...
  test('@smoke GET /api/authenticate - isAuthenticated - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/csrf-token-gateway - unknown - Happy Path', async ({ authenticatedApi }) => {
