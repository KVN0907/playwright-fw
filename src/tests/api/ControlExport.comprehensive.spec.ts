...
test.describe('ControlExportResource API Tests', () => {
  test('@smoke POST /api/control/export - getAllControlForExport - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/control/export - getExportReportForMappedControls - Happy Path', async ({
    authenticatedApi,
  }) => {
