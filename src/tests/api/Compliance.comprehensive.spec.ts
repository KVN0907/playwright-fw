...
test.describe('ComplianceResource API Tests', () => {
  test('@smoke POST /api/compliances - createCompliance - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/compliances - idexists', async ({ authenticatedApi }) => {
    ...
    // When making POST request with invalid data
    try {
      const response = await authenticatedApi.post('/api/compliances', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/compliances/{id} - updateCompliance - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/compliances/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/compliances/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/compliances/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/compliances/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/compliances/{id} - getCompliance - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/compliances/deleteByComplianceDocId/{complianceDocId} - unknown - Happy Path', async ({ authenticatedApi }) => {
    ...
    const response = await authenticatedApi.delete('/api/compliances/deleteByComplianceDocId/${complianceDocId}');
  ...
  test('@smoke GET /api/compliancesdownloadByDocId/{complianceDocId} - downloadComplianceDocByDocId - Happy Path', async ({ authenticatedApi }) => {
    ...
    // When making authenticated GET request
    const response = await authenticatedApi.get('/api/compliancesdownloadByDocId/${complianceDocId}');
  ...
  test('@smoke GET /api/compliancesdownloadAllDocs/{complianceId} - downloadMultipleComplianceDocsByDocId - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/compliancestoggle-status/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/compliances/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/compliances/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/compliances - bulkUploadCompliances - Happy Path', async ({ authenticatedApi }) => {
    Log.info('Testing POST /api/compliances');
  ...
  test('@smoke GET /api/compliances/bulk-upload/edit-template - downloadBulkEditTemplate - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/compliances/compliance-list - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/compliances/list-items - unknown - Happy Path', async ({ authenticatedApi }) => {
