...
test.describe('ServerResource API Tests', () => {
  ...
  test('@negative POST /api/server - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/server', requestData);
    } catch (error) {
  ...
  test('@negative POST /api/server - idnotexists', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/server');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/server/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/server/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/server/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/server/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/server/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/server/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/server/{id} - getServerWithConnectors - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/server/initiate-approval/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative DELETE /api/server/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.delete('/api/server/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/server/environments - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/server/operating-systems - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/server/database-types - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/server/owners-emails - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
