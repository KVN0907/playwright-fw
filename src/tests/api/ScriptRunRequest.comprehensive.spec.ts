...
test.describe('ScriptRunRequestResource API Tests', () => {
  test('@smoke POST /api/script-run-requests - createScriptRunRequest - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/script-run-requests/{id} - updateScriptRunRequest - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/script-run-requests/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/script-run-requests/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/script-run-requests/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/script-run-requests/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PATCH /api/script-run-requests - partialUpdateScriptRunRequest - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PATCH /api/script-run-requests - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PATCH request with invalid data
    try {
      const response = await authenticatedApi.patch('/api/script-run-requests');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/script-run-requests - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/script-run-requests/{id} - getScriptRunRequest - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/script-run-requests/{id} - deleteScriptRunRequest - Happy Path', async ({ authenticatedApi }) => {
