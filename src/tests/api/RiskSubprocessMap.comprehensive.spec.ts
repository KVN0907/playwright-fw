...
test.describe('RiskSubprocessMapResource API Tests', () => {
  test('@smoke POST /api/risk-subprocess-map - createRiskSubprocessMap - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risk-subprocess-map/{riskId} - getRiskSubProcessMap - Happy Path', async ({
    authenticatedApi,
  }) => {
