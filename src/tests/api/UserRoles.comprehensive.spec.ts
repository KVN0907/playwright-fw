...
test.describe('UserRolesResource API Tests', () => {
  test('@smoke POST /api/user-roles - createUserRoles - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/user-roles - notAssignableRole', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/user-roles');
    } catch (error) {
  ...
  test('@negative POST /api/user-roles - idexists', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/user-roles', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative POST /api/user-roles - userRoleCombinationExist', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke PUT /api/user-roles - updateUserRoles - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/user-roles - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/user-roles', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/user-roles - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/user-roles');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/user-roles/getById - getUserRoles - Happy Path', async ({
    authenticatedApi,
  }) => {
