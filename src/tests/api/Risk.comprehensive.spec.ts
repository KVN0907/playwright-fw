...
test.describe('RiskResource API Tests', () => {
  ...
  test('@negative POST /api/risk - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/risk', requestData);
    } catch (error) {
  ...
  test('@negative POST /api/risk - riskratingtypenotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/risk');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/risk/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/risk/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/risk/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/risk/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/risk/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/risk/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/riskdownloadByDocId/{riskDocId} - downloadRiskDocByDocId - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risktoggle-status/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risk/application-details-from-list-page/{id} - getApplicationDetailsFromListPage - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.get(
      '/api/risk/application-details-from-list-page/${id}'
    );
  ...
  test('@smoke GET /api/risk/filter-options - getAllFilterOptions - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risk/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risk/bulk-upload/edit-template - downloadBulkEditTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/risk/details/{id} - getRiskDetails - Happy Path', async ({
    authenticatedApi,
  }) => {
