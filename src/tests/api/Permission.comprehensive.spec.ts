...
test.describe('PermissionResource API Tests', () => {
  test('@smoke POST /api/permissions - createPermission - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/permissions - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/permissions', requestData);
    } catch (error) {
  ...
  test('@negative POST /api/permissions - permissionExist', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/permissions');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/permissions - updatePermission - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/permissions - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/permissions', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/permissions - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/permissions');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/permissions/find-all-permissions - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke POST /api/permissions/getById - getPermission - Happy Path', async ({
    authenticatedApi,
  }) => {
