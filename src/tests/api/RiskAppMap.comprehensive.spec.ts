...
test.describe('RiskAppMapResource API Tests', () => {
  test('@smoke POST /api/risk-app-map - createRiskAppMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/risk-app-map/{id} - getRiskAppMap - Happy Path', async ({ authenticatedApi }) => {
