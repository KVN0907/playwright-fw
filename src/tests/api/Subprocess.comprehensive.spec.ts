...
test.describe('SubprocessResource API Tests', () => {
  test('@smoke POST /api/subprocess - createSubprocess - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/subprocess - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      const response = await authenticatedApi.post('/api/subprocess', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/subprocess/{id} - updateSubprocess - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/subprocess/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    try {
      const response = await authenticatedApi.put('/api/subprocess/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/subprocess/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/subprocess/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke DELETE /api/subprocess/deleteBySubprocessDocId/{subprocessDocId} - unknown - Happy Path', async ({ authenticatedApi }) => {
    ...
    const response = await authenticatedApi.delete('/api/subprocess/deleteBySubprocessDocId/${subprocessDocId}');
  ...
  test('@smoke GET /api/subprocessdownloadByDocId/{subprocessDocId} - downloadSubprocessDocByDocId - Happy Path', async ({ authenticatedApi }) => {
    ...
    const response = await authenticatedApi.get('/api/subprocessdownloadByDocId/${subprocessDocId}');
  ...
  test('@smoke GET /api/subprocess/{id} - getSubprocess - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/subprocess/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/subprocesstoggle-status/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
