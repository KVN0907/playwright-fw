...
test.describe('ComplianceRequirementResource API Tests', () => {
  test('@smoke POST /api/compliance-requirements - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/compliance-requirements - emptylist', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/compliance-requirements');
    } catch (error) {
  ...
  test('@negative POST /api/compliance-requirements - idexists', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/compliance-requirements', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/compliance-requirements/single - createSingleComplianceRequirement - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.post(
      '/api/compliance-requirements/single',
      requestData
    );
  ...
  test('@negative POST /api/compliance-requirements/single - idexists', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: idexists');
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.post('/api/compliance-requirements/single', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/compliance-requirements/{id} - updateComplianceRequirement - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/compliance-requirements/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/compliance-requirements/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/compliance-requirements/{id} - idinvalid', async ({
    authenticatedApi,
  }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/compliance-requirements/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/compliance-requirements/{id} - idnotfound', async ({
    authenticatedApi,
  }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/compliance-requirements/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/compliance-requirements - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/compliance-requirements/by-compliance/{complianceId} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.get(
      '/api/compliance-requirements/by-compliance/${complianceId}'
    );
  ...
  test('@smoke GET /api/compliance-requirements/{id} - getComplianceRequirement - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke DELETE /api/compliance-requirements/{id} - deleteComplianceRequirement - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/compliance-requirements/bulk-upload/template - downloadBulkUploadTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    // When making authenticated GET request
    const response = await authenticatedApi.get(
      '/api/compliance-requirements/bulk-upload/template'
    );
  ...
  test('@smoke POST /api/compliance-requirements - bulkUploadComplianceRequirements - Happy Path', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing POST /api/compliance-requirements');
  ...
  test('@smoke GET /api/compliance-requirements/bulk-upload/edit-template/{complianceId} - downloadBulkEditTemplate - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    // When making authenticated GET request
    const response = await authenticatedApi.get(
      '/api/compliance-requirements/bulk-upload/edit-template/${complianceId}'
    );
