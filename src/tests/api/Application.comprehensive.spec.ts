...
test.describe('ApplicationResource API Tests', () => {
  test('@smoke POST /api/applications - createApplication - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/applications - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/applications', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/applications/{id} - updateApplication - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/applications/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/applications/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/applications/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/applications/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/applications/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/applications/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/applications/list - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/filter-options - getAllFilterOptions - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/{id} - getApplication - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/details/{id} - getApplicationDetails - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/details-from-list-page/{id} - getApplicationDetailsFromListPage - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/details-all/{id} - getApplicationAllDetails - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/applications/details-view/{id} - getApplicationAllDetailsForView - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke DELETE /api/applications/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative DELETE /api/applications/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.delete('/api/applications/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/applicationstoggle-status/{id} - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative GET /api/applicationstoggle-status/{id} - idnotfound', async ({
    authenticatedApi,
  }) => {
    Log.info('Testing error scenario: idnotfound');
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.get('/api/applicationstoggle-status/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke POST /api/applications/details-by-location - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
    ...
    const response = await authenticatedApi.post(
      '/api/applications/details-by-location',
      requestData
    );
  ...
  test('@smoke POST /api/applications/list-items - unknown - Happy Path', async ({
    authenticatedApi,
  }) => {
