...
test.describe('EyGroupResource API Tests', () => {
  test('@smoke POST /api/ey-groups/organization - createOrganization - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/ey-groups/organization - userNameExist', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/ey-groups/organization - shortFormExist', async ({ authenticatedApi }) => {
    ...
    // When making POST request with invalid data
    try {
      const response = await authenticatedApi.post('/api/ey-groups/organization');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative POST /api/ey-groups/organization - notAuthorize', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/ey-groups/organization - updateOrganization - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/ey-groups/organization - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/ey-groups/organization');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/ey-groups/organization - shortFormExist', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: shortFormExist');
  ...
  test('@smoke GET /api/ey-groups/organization - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/ey-groups/organization/detailsById - getOrganization - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/ey-groups/company - createCompany - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/ey-groups/company - shortFormExist', async ({ authenticatedApi }) => {
    ...
    // When making POST request with invalid data
    try {
      const response = await authenticatedApi.post('/api/ey-groups/company');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/ey-groups/company - updateCompany - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/ey-groups/company - idinvalid', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/ey-groups/company');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/ey-groups/company/{id} - getCompany - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/ey-groups/organization/verification-mail - sendVerificationMail - Happy Path', async ({ authenticatedApi }) => {
    ...
    // When making authenticated POST request
    const response = await authenticatedApi.post('/api/ey-groups/organization/verification-mail', requestData);
  ...
  test('@smoke GET /api/ey-groups/all-login-user-child - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/ey-groups/login - getEyGroupByLogin - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke PUT /api/ey-groups/organization/updateIsActive - updateIsActiveEyGroupOrganization - Happy Path', async ({ authenticatedApi }) => {
    ...
    // When making authenticated PUT request
    const response = await authenticatedApi.put('/api/ey-groups/organization/updateIsActive', requestData);
  ...
  test('@negative PUT /api/ey-groups/organization/updateIsActive - idnull', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: idnull');
  ...
  test('@negative PUT /api/ey-groups/organization/updateIsActive - idinvalid', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: idinvalid');
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/ey-groups/organization/updateIsActive');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/ey-groups/organization/updateIsActive - idnotfound', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: idnotfound');
  ...
  test('@negative PUT /api/ey-groups/organization/updateIsActive - shortFormExist', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: shortFormExist');
  ...
  test('@negative PUT /api/ey-groups/organization/updateIsActive - notAuthorize', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: notAuthorize');
  ...
  test('@security PUT /api/ey-groups/organization/updateIsActive - Unauthorized Access', async ({ request }) => {
    Log.info('Testing unauthorized access');
    ...
    let response;
    try {
      response = await unauthApi.put('/api/ey-groups/organization/updateIsActive', undefined, { skipAuth: true });
    } catch (error) {
      Log.info('Expected auth error caught');
    }
  ...
  test('@smoke POST /api/ey-groups/company/detailsById - getCompanyById - Happy Path', async ({ authenticatedApi }) => {
