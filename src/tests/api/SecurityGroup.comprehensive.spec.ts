...
test.describe('SecurityGroupResource API Tests', () => {
  test('@smoke POST /api/security-groups - createSecurityGroup - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/security-groups - securityGroupExist', async ({ authenticatedApi }) => {
    ...
    // When making POST request with invalid data
    try {
      const response = await authenticatedApi.post('/api/security-groups');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PUT /api/security-groups - updateSecurityGroup - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/security-groups - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/security-groups');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/security-groups - ifSecurityGroupExist', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/security-groups/find-all-security-groups - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/security-groups/find-all-assignable-security-groups - unknown - Happy Path', async ({ authenticatedApi }) => {
    ...
    // When making authenticated GET request
    const response = await authenticatedApi.get('/api/security-groups/find-all-assignable-security-groups');
  ...
  test('@smoke POST /api/security-groups/getById - getSecurityGroup - Happy Path', async ({ authenticatedApi }) => {
