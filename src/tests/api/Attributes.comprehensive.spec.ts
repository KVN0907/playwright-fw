...
test.describe('AttributesResource API Tests', () => {
  test('@smoke POST /api/attributes - createAttributes - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/attributes - invalidpayload', async ({ authenticatedApi }) => {
    ...
    try {
      const response = await authenticatedApi.post('/api/attributes');
    } catch (error) {
  ...
  test('@smoke GET /api/attributes/{controlId} - getAttributesByControlId - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke DELETE /api/attributes/delete/{id} - unknown - Happy Path', async ({ authenticatedApi }) => {
