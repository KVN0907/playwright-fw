...
test.describe('RawMetadataResource API Tests', () => {
  test('@smoke POST /api/raw-metadata - createRawMetadata - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative POST /api/raw-metadata - idexists', async ({ authenticatedApi }) => {
    ...
    try {
      response = await authenticatedApi.post('/api/raw-metadata', requestData);
    } catch (error) {
  ...
  test('@smoke PUT /api/raw-metadata/{id} - updateRawMetadata - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PUT /api/raw-metadata/{id} - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/raw-metadata/{id}', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/raw-metadata/{id} - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/raw-metadata/{id}');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/raw-metadata/{id} - idnotfound', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.put('/api/raw-metadata/' + nonExistentId + '');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke PATCH /api/raw-metadata - partialUpdateRawMetadata - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@negative PATCH /api/raw-metadata - idnull', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.patch('/api/raw-metadata', requestData);
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PATCH /api/raw-metadata - idinvalid', async ({ authenticatedApi }) => {
    ...
    let response: Awaited<ReturnType<typeof authenticatedApi.post>> | undefined;
    try {
      response = await authenticatedApi.patch('/api/raw-metadata');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@smoke GET /api/raw-metadata/{id} - getRawMetadata - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke DELETE /api/raw-metadata/{id} - deleteRawMetadata - Happy Path', async ({
    authenticatedApi,
  }) => {
