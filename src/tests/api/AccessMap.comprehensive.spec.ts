...
test.describe('AccessMapResource API Tests', () => {
  test('@smoke GET /api/access-map/get-access-map - getAccessMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/access-map/has-access - hasAccess - Happy Path', async ({ authenticatedApi }) => {
