...
test.describe('SecurityGroupRoutePermissionResource API Tests', () => {
  test('@smoke POST /api/security-group-route-permissions - createSecurityGroupRoutePermission - Happy Path', async ({ authenticatedApi }) => {
    ...
    const response = await authenticatedApi.post('/api/security-group-route-permissions', requestData);
  ...
  test('@negative POST /api/security-group-route-permissions - idexists', async ({ authenticatedApi }) => {
  ...
  test('@negative POST /api/security-group-route-permissions - securityGroupPathPermissionCombinationExist', async ({ authenticatedApi }) => {
    ...
    // When making POST request with invalid data
    try {
      const response = await authenticatedApi.post('/api/security-group-route-permissions');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative POST /api/security-group-route-permissions - notAuthorize', async ({ authenticatedApi }) => {
  ...
  test('@security POST /api/security-group-route-permissions - Unauthorized Access', async ({ request }) => {
    ...
    let response;
    try {
      response = await unauthApi.post('/api/security-group-route-permissions', undefined, { skipAuth: true });
    } catch (error) {
  ...
  test('@smoke PUT /api/security-group-route-permissions - updateSecurityGroupRoutePermission - Happy Path', async ({ authenticatedApi }) => {
    ...
    const response = await authenticatedApi.put('/api/security-group-route-permissions', requestData);
  ...
  test('@negative PUT /api/security-group-route-permissions - idnull', async ({ authenticatedApi }) => {
  ...
  test('@negative PUT /api/security-group-route-permissions - idnotfound', async ({ authenticatedApi }) => {
    ...
    // When making PUT request with invalid data
    try {
      const response = await authenticatedApi.put('/api/security-group-route-permissions');
    } catch (error) {
      // Expected error from APITestHelper
      Log.info('Expected error caught');
    }
  ...
  test('@negative PUT /api/security-group-route-permissions - securityGroupPathPermissionCombinationExist', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: securityGroupPathPermissionCombinationExist');
  ...
  test('@negative PUT /api/security-group-route-permissions - notAuthorize', async ({ authenticatedApi }) => {
    Log.info('Testing error scenario: notAuthorize');
  ...
  test('@security PUT /api/security-group-route-permissions - Unauthorized Access', async ({ request }) => {
    Log.info('Testing unauthorized access');
    ...
    let response;
    try {
      response = await unauthApi.put('/api/security-group-route-permissions', undefined, { skipAuth: true });
    } catch (error) {
      Log.info('Expected auth error caught');
    }
  ...
  test('@smoke GET /api/security-group-route-permissions - unknown - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke POST /api/security-group-route-permissions/getById - getSecurityGroupRoutePermission - Happy Path', async ({ authenticatedApi }) => {
