...
test.describe('ControlSubProcessMapResource API Tests', () => {
  test('@smoke POST /api/control-subprocess-map - createControlSubProcessMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control-subprocess-map/{id} - getControlSubProcessMap - Happy Path', async ({ authenticatedApi }) => {
