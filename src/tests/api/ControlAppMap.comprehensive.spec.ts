...
test.describe('ControlAppMapResource API Tests', () => {
  test('@smoke POST /api/control-app-map - createControlAppMap - Happy Path', async ({ authenticatedApi }) => {
  ...
  test('@smoke GET /api/control-app-map/{id} - getControlAppMap - Happy Path', async ({ authenticatedApi }) => {
