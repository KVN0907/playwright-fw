...
test.describe('ApplicationExportResource API Tests', () => {
  test('@smoke POST /api/application/export - exportApplications - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/application/export - exportApplicationById - Happy Path', async ({
    authenticatedApi,
  }) => {
