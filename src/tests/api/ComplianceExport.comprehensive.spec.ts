...
test.describe('ComplianceExportResource API Tests', () => {
  test('@smoke POST /api/compliances/export - getAllCompliancesForExport - Happy Path', async ({
    authenticatedApi,
  }) => {
  ...
  test('@smoke GET /api/compliances/export - getExportReportForMappedCompliance - Happy Path', async ({
    authenticatedApi,
  }) => {
