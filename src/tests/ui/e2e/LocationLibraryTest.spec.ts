...
test.describe('Location Library Management Tests', () => {
  ...
  test('@smoke @critical User can access Location Library and verify all page elements are present', async ({
    locationLibraryPage,
  }) => {
  ...
  test('@regression User can view location data in table with correct format', async ({
    locationLibraryPage,
  }) => {
  ...
  test('User can access Create Location form and verify all form fields', async ({
    page,
    locationLibraryPage,
  }) => {
    // Given user is on Location Library page
  ...
  test('User can navigate back from Create page to list view', async ({ locationLibraryPage }) => {
    // Given user is on Create Location form
    await locationLibraryPage.navigateToLocationLibrary();
    await locationLibraryPage.openCreateLocationForm();
  ...
  test('User can sort data in the location table', async ({ locationLibraryPage }) => {
  ...
  test('User can navigate through pagination controls', async ({ page, locationLibraryPage }) => {
    // Given user is on Location Library page
    await locationLibraryPage.navigateToLocationLibrary();
  ...
  test('User can access all navigation menu items', async ({ page, locationLibraryPage }) => {
    // Given user is on Location Library page
    await locationLibraryPage.navigateToLocationLibrary();
