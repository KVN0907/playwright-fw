...
export class LocationLibraryPage extends BasePage {
  // Navigation elements
  ...
  constructor(page: Page) {
    ...
    // Navigation elements
    this.controlDefinitionLibrariesMenu = page.getByRole('button', { name: 'Control Definition Libraries' });
    ...
    this.breadcrumbLocationLibrary = page.locator('breadcrumb').getByRole('link', { name: 'Location Library' });
    ...
    this.locationOwnerEmailDropdown = page.getByRole('combobox', { name: 'Please select an option' }).first();
    this.regionNameField = page.getByRole('combobox', { name: 'Search Bar' });
    this.countryNameDropdown = page.getByRole('combobox', { name: 'Please select an option' }).nth(1);
   ...
   */
  async navigateToLocationLibrary(): Promise<void> {
    ...
    if (isExpanded !== 'true') {
      await this.clickElement(this.controlDefinitionLibrariesMenu, 'Control Definition Libraries menu');
    }
    
    // Click on Location Library link
    await this.clickElement(this.locationLibraryNavLink, 'Location Library navigation link');
   ...
   */
  async navigateToCreateLocation(): Promise<void> {
  ...
  async fillLocationForm(locationData: {
    ...
    await this.fillElement(this.applicableEntityField, locationData.applicableEntity, 'Applicable Entity field');
  ...
  async verifyLocationLibraryPageElements(): Promise<void> {
  ...
  async verifyLocationDataFormat(): Promise<void> {
  ...
  async openCreateLocationForm(): Promise<void> {
  ...
  async verifyNavigationBackToList(): Promise<void> {
  ...
  async verifyTableSorting(): Promise<void> {
    ...
    await this.clickElement(this.identifierHeader, 'Identifier column header');
